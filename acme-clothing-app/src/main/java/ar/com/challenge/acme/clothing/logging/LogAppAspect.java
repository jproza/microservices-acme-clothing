package ar.com.challenge.acme.clothing.logging;
...
public class LogAppAspect {
  ...
  @Around("@annotation(ar.com.challenge.acme.clothing.logging.LogApp)")
  public Object log(ProceedingJoinPoint point) throws Throwable {
    var codeSignature = (CodeSignature) point.getSignature();
    var methodSignature = (MethodSignature) point.getSignature();
    Method method = methodSignature.getMethod();
    Logger logger = LoggerFactory.getLogger(method.getDeclaringClass());
    var annotation = method.getAnnotation(LogApp.class);
